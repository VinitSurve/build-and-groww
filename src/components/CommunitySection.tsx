                ...
                <div className="max-w-[1440px] mx-auto h-full relative">
                    ...
                    <div className="absolute inset-6 md:inset-10 mx-auto w-full max-w-[1200px] h-full pointer-events-none z-0">
                        <div className="absolute inset-0 rounded-xl overflow-hidden">
                            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://cdn.jsdelivr.net/gh/randomaiphoto/build-and-grow-media@main/community.webp')" }} />
            ...
            <div className="relative z-20 max-w-4xl mx-auto text-center space-y-8 sm:space-y-12">
                <div className="space-y-4 sm:space-y-6">
                    ...
                    <p className="animate-reveal text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto font-light leading-relaxed px-4">
                        Connect with local developers, mentors, and organizers from GDG Cloud Mumbai and GDG Cloud Pune. Join discussions, find collaborators, and receive event updates, learning resources, and support from the community.
                    </p>
                </div>
                ...
                <div className="animate-reveal pt-2 sm:pt-4 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="https://linktr.ee/gdgcloudmumbai" target="_blank" rel="noreferrer" className="w-full max-w-xs sm:w-auto inline-block bg-[#1c1d20] hover:bg-[#2c2d30] text-white border border-white/10 px-4 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base font-medium transition-all shadow-2xl hover:shadow-blue-500/10 active:scale-95">
                        Join GDG Cloud Mumbai
                    </a>
                    <a href="https://linktr.ee/gdgcloudpune" target="_blank" rel="noreferrer" className="w-full max-w-xs sm:w-auto inline-block bg-[#1c1d20] hover:bg-[#2c2d30] text-white border border-white/10 px-4 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base font-medium transition-all shadow-2xl hover:shadow-blue-500/10 active:scale-95">
                        Join GDG Cloud Pune
                    </a>
                </div>
            </div>
