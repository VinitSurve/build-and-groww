            ...
            >
                ...
                >
                    ...
                    >
                        Build & Grow
                        <img
                            src="https://cdn.jsdelivr.net/gh/randomaiphoto/build-and-grow-media@main/BGAI.webp"
                            alt="AI Hackathon"
                    ...
                    <div className="mt-2 sm:mt-3 md:mt-4 lg:mt-6 flex justify-center md:justify-start">
                        <img
                            src="https://cdn.jsdelivr.net/gh/randomaiphoto/build-and-grow-media@main/initiative.webp"
                            alt="Initiative"
