...
const mumbaiOrganizers = [
  ...
  { name: "Niharika Dhanik", role: "Cloud Engineer", company: "Searce Inc", bio: "Cloud whiz, community builder — obsessed with observability and sharing knowledge.", image: "/Niharika%20Dhanik.webp", profile: "https://linktr.ee/niharikadhanik", github: "https://github.com/niharicka2602/", linkedin: "https://www.linkedin.com/in/niharikadhanik/" },
...
const puneOrganizers = [
  { name: "Antrixsh Gupta", role: "GDG Organizer", company: "", image: "antrixsh_gupta_imgupscaler.ai_V1(Fast)_2K.webp", linkedin: "https://www.linkedin.com/in/antrixshgupta" },
  { name: "Pratik Kale", role: "Co-Organizer", company: "Impulsive Web", image: "pratik_kale_JE4xYmT_imgupscaler.ai_V1(Fast)_2K.webp", profile: "pratikkale.in", email: "ppvkale@gmail.com", linkedin: "https://www.linkedin.com/in/pratikkalein/" },
  { name: "Dnyanada Mahajan", role: "Co Organizer", company: "Gen Digital - NortonLifeLock", image: "dnyanada_mahajan_imgupscaler.ai_V1(Fast)_2K.webp", linkedin: "linkedin.com/in/dnyanadam" },
  { name: "Vatsal Jain", role: "Event Organizer", company: "vConstruct Pvt Ltd", image: "vatsal_jain_9uuB5SU_imgupscaler.ai_V1(Fast)_2K.webp", linkedin: "linkedin.com/in/vatsaljain0205" }
];
